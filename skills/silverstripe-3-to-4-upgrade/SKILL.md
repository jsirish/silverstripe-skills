...
> [!TIP]
> The example-multiarea project has a working reference for this pattern: `~/Sites/example-multiarea` (SS4) vs `~/Sites/example-multiarea-legacy` (SS3). Use it as a template for the ddev config setup.
